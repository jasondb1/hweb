...
void printEquipmentStatus(Equipment* equipment, const char* nameString) {
  ...
  if (equipment->isRunning) {
    printTime(equipment->timeOn - equipment->interval);
    lcd.print('-');
...
void turnEquipmentOff(Equipment* equipment) {
  ...
  digitalWrite(equipment->pin, HIGH); //equipment off
