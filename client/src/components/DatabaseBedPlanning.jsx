...
let tableColumns = [
    ...
    { name: 'EarliestHarvestDate', columnName: 'Earliest Harvest Date', isDisplayed: true, type: 'text' },
    ...
    { name: 'PlantedBy', columnName: 'Planted By', isDisplayed: true, type: 'text' },
...
let formFields = [
    ...
    { name: 'PlantingDate', value: '', fieldName: 'Planting Date', type: 'text' },
    { name: 'EarliestHarvestDate', value: '', fieldName: 'Earliest Harvest Date', type: 'text' },
    { name: 'LatestHarvestDate', value: '', fieldName: 'Latest Harvest Date', type: 'text' },
    { name: 'DirectSeed', value: null, fieldName: 'Direct Seed', type: 'toggle' },
    ...
    { name: 'DateGerminated', value: '', fieldName: 'Date Germinated', type: 'text' },
...
class BedPlanning extends React.Component {
